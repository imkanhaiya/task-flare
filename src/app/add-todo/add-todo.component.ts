...
export class AddTodoComponent implements OnInit {
  ...
  applyMargin(todoForm: any) {
    ...
    if (
      (titleControl?.touched && titleControl?.invalid) ||
      titleControl?.invalid & titleControl?.dirty ||
      (detailsControl?.touched && detailsControl?.invalid) ||
      detailsControl?.invalid & detailsControl?.dirty ||
      (statusControl?.touched && statusControl?.invalid) ||
      statusControl?.invalid & statusControl?.dirty ||
      (dueDateControl?.touched && dueDateControl?.invalid) ||
      dueDateControl?.invalid & dueDateControl?.dirty
    ) {
